...
writematrix(RX_FFT,'DASC_Charron_baseband_fss_RX_fft.csv');
writematrix(rx_fft_theo,'DASC_Charron_baseband_MM_fft.csv');
writematrix(TX_FFT,'DASC_Charron_baseband_TX_fft.csv');
save('DASC_Charron_baseband_sim1_data.mat', 'RX_FFT', 'rx_fft_theo', 'TX_FFT');
